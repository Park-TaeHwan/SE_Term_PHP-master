...
if($bn!=NULL && $au!=NULL)
{
	$sql=mysqli_query($set,"INSERT INTO books(name, author, price, category, available) VALUES('$bn','$au', '$pr', '$ca', '$av')");
	if($sql)
	{
...
<tr><td class="labels">price : </td><td><input type="text" name="price" placeholder="Enter price" size="25" class="fields" required="required"  /></td></tr>
<tr><td class="labels">category : </td><td><input type="text" name="cate" placeholder="Enter category" size="25" class="fields" required="required"  /></td></tr>
<tr><td class="labels">available : </td><td><input type="text" name="avail" placeholder="Enter available amount" size="25" class="fields" required="required"  /></td></tr>
